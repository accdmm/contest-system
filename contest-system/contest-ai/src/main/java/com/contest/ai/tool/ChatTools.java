...
public class ChatTools {
    ...
    public String queryContests(String keyword, String category, Integer page, Integer size) {
        try {
            ...
            IPage<Contest> result = contestService.pageContests(p, s, keyword, category, 1, null, null);
    ...
    public String searchContestDetail(String contestName) {
        try {
            IPage<Contest> result = contestService.pageContests(1, 5, contestName, null, 1, null, null);
            List<Contest> records = result.getRecords();
            if (records.isEmpty()) {
    ...
    public String registerForContest(String contestName, String remark) {
        ...
        try {
            IPage<Contest> result = contestService.pageContests(1, 10, contestName, null, 1, null, null);
            List<Contest> records = result.getRecords();
            if (records.isEmpty()) {
