...
public class ChatTools {
    ...
    public String queryContests(String keyword, String category, Integer page, Integer size) {
        try {
            ...
            IPage<Contest> result = contestService.pageContests(p, s, keyword, category, CommonConstants.CONTEST_OPEN, null);
    ...
    public String searchContestDetail(String contestName) {
        try {
            IPage<Contest> result = contestService.pageContests(1, 5, contestName, null, CommonConstants.CONTEST_OPEN, null);
            List<Contest> records = result.getRecords();
            if (records.isEmpty()) {
    ...
    public String registerForContest(String contestName, String remark) {
        ...
        try {
            IPage<Contest> result = contestService.pageContests(1, 10, contestName, null, CommonConstants.CONTEST_OPEN, null);
            List<Contest> records = result.getRecords();
            if (records.isEmpty()) {
